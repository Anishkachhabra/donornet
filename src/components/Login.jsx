...
class Login extends Component {
  ...
  render() {
    return (
      <div className="container-fluid min-vh-100 bg-light d-flex justify-content-center align-items-center" style={{ padding: "50px" }}>
      <div className="card shadow border-0" style={{ minWidth: "400px", minHeight: "500px"}}>
